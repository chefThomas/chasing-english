...
const text = {
  ...
  subscriptionPaymentDetails: (
    <>
      <p>
        Enrolling in 1:1 sessions secures a weekly occurring hour-long time slot
        for a minimum of 4 meetings (one month) and <i>up to</i> the duration of
        the school year.
      </p>
      <p>
        Once signed-up through the website, families can expect monthly invoices
        to be sent the week prior to a new month to secure the student’s spot
        for another month of 1:1 sessions. These monthly invoices will be sent
        until notice is given to Chasing English that 1:1 sessions are no longer
        needed.
      </p>
      <p>
        Please provide notice by email to Kendra <i>at least two weeks</i> in
        advance so she can open the spot up for other students who may be on a
        waitlist.{' '}
      </p>
      <p>
        Please also note that breaks in Chasing English instruction coincide
        with scheduled school breaks (for example, Spring and Winter breaks),
  ...
  indCoachp1:
    'Subscribing to these weekly, hour-long, individual coaching sessions is an excellent way to support academic success and provide confidence-building opportunities designed to meet the specific needs of your student. Whether the desire is to become a stronger writer, develop critical thinking skills, or hone reading comprehension, this flexibly-designed program focuses on areas of need to maximize improvement and achievement.',
  indCoachp2:
    'Families receive weekly reports on subject matter and progression to ensure students are getting the most out of this highly-tailored program.',
  groupp1:
    'Group courses offer a creative and enriching experience for middle and high schools students seeking to explore and develop literary skills. In addition to encouraging academic growth, offering and receiving feedback and engaging in group discussions helps students develop universally valuable soft skills like communication and collaboration.',
  groupp2:
    'Throughout course duration, families receive weekly emails detailing material covered in previous lessons as well as a preview of what is to come in the following meeting.',
};
